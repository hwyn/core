...
var dynamic_1 = require("../instruction/dynamic");
...
var NodeFactory = /** @class */ (function () {
        ...
        return tslib_1.__awaiter(this, void 0, Promise, function () {
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 6, , 7]);
                        if (!(instruction instanceof dynamic_1.DynamicInstruction)) return [3 /*break*/, 4];
                        _c.label = 1;
                    case 1:
                        _c.trys.push([1, 3, , 4]);
                    ...
                    case 3:
                        ...
                        if (policy_1.KernelPolicy.debugMode) {
                            policy_1.KernelPolicy.logger.warn("[NodeFactory] DynamicInstruction '".concat(instruction.slotName, "' self-resolution failed. Falling back to Registry."), e_1.message);
                        }
                        return [3 /*break*/, 4];
                    case 4:
                        protocol = ((_a = context === null || context === void 0 ? void 0 : context.seed) === null || _a === void 0 ? void 0 : _a.protocol) || instruction.protocol;
                        if (!protocol) {
                            throw new exceptions_1.RuntimeConfigurationException("Cannot determine Protocol for slot: ".concat(instruction.slotName, ". Protocol context is required for resolution."), { slotName: instruction.slotName });
                        }
                        resolverToken = this.registry.getResolverToken(instruction.slotName, protocol);
                        if (!resolverToken) {
                            throw new exceptions_1.RuntimeConfigurationException("No resolver registered for slot: ".concat(instruction.slotName, ". Ensure the Plugin providing this slot is loaded."), { slotName: instruction.slotName });
                        }
                        resolver = injector.get(resolverToken);
                        if (!resolver || typeof resolver.resolve !== 'function') {
                            throw new exceptions_1.RuntimeConfigurationException("Invalid resolver implementation for slot: ".concat(instruction.slotName, ". Resolver must implement ISlotResolver."), { slotName: instruction.slotName, resolvedValue: resolver });
                        }
    ...
    var _a;
    NodeFactory = tslib_1.__decorate([
        (0, di_1.Injectable)(),
