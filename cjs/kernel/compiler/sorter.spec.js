...
var MockRegistry = /** @class */ (function (_super) {
    tslib_1.__extends(MockRegistry, _super);
...
function runTests() {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        var passed, total, registry, sorter, instructions, sorted, registry, sorter, instructions, sorted, registry, sorter, instructions, sorted, registry, sorter_2, instructions_1, registry, sorter_3, instructions_2, registry, sorter, instructions, sorted, registry, sorter, instructions, resultB, instructionsA, resultA;
        return tslib_1.__generator(this, function (_a) {
            ...
            // --- Scenario 1: Same Stage Linear (A -> B) ---
            {
                ...
                registry.registerMockSlot({ name: 'SLOT_A', protocol: PROTO_A, stage: types_1.SlotStage.PROCESS, anchors: { before: ['SLOT_B'] }, profiles: ['default'] });
                registry.registerMockSlot({ name: 'SLOT_B', protocol: PROTO_A, stage: types_1.SlotStage.PROCESS, profiles: ['default'] });
                sorter = new sorter_1.PipelineSorter(registry);
                instructions = [
            ...
            {
                registry = new MockRegistry();
                registry.registerMockSlot({ name: 'SLOT_A', protocol: PROTO_A, stage: types_1.SlotStage.PROCESS, profiles: ['default'] });
                registry.registerMockSlot({ name: 'SLOT_B', protocol: PROTO_A, stage: types_1.SlotStage.PROCESS, profiles: ['default'] });
                sorter = new sorter_1.PipelineSorter(registry);
                instructions = [
            ...
            {
                registry = new MockRegistry();
                registry.registerMockSlot({ name: 'INGRESS_A', protocol: PROTO_A, stage: types_1.SlotStage.INGRESS, profiles: ['default'] });
                registry.registerMockSlot({ name: 'PROCESS_A', protocol: PROTO_A, stage: types_1.SlotStage.PROCESS, profiles: ['default'] });
                registry.registerMockSlot({ name: 'EGRESS_A', protocol: PROTO_A, stage: types_1.SlotStage.EGRESS, profiles: ['default'] });
                sorter = new sorter_1.PipelineSorter(registry);
                instructions = [
            ...
            // --- Scenario 4: Cross Stage Violation (Ingress depends on Process) ---
            {
                ...
                registry.registerMockSlot({ name: 'INGRESS_A', protocol: PROTO_A, stage: types_1.SlotStage.INGRESS, anchors: { after: ['PROCESS_A'] }, profiles: ['default'] });
                registry.registerMockSlot({ name: 'PROCESS_A', protocol: PROTO_A, stage: types_1.SlotStage.PROCESS, profiles: ['default'] });
                sorter_2 = new sorter_1.PipelineSorter(registry);
                instructions_1 = [
                    { slotName: 'INGRESS_A', protocol: PROTO_A },
                    { slotName: 'PROCESS_A', protocol: PROTO_A }
                ];
                // This should throw Topology Violation
                assertThrow(function () { return sorter_2.sort(instructions_1, PROTO_A); }, 'Topology Violation', 'Scenario 4: Should detect basic stage violation');
            }
            // --- Scenario 5: Circular Dependency (A -> B -> A) within same stage ---
            {
                registry = new MockRegistry();
                registry.registerMockSlot({ name: 'SLOT_A', protocol: PROTO_A, stage: types_1.SlotStage.PROCESS, anchors: { before: ['SLOT_B'] }, profiles: ['default'] });
                registry.registerMockSlot({ name: 'SLOT_B', protocol: PROTO_A, stage: types_1.SlotStage.PROCESS, anchors: { before: ['SLOT_A'] }, profiles: ['default'] });
                sorter_3 = new sorter_1.PipelineSorter(registry);
                instructions_2 = [
                    { slotName: 'SLOT_A', protocol: PROTO_A },
                    { slotName: 'SLOT_B', protocol: PROTO_A }
                ];
                // This should throw Circular Dependency
                assertThrow(function () { return sorter_3.sort(instructions_2, PROTO_A); }, 'Circular Dependency', 'Scenario 5: Should detect circular dependency');
            }
            ...
            // --- Scenario 7: Protocol Isolation (Same Slot Name, Different Logic) ---
            {
                ...
                registry.registerMockSlot({ name: 'AUTH', protocol: PROTO_A, stage: types_1.SlotStage.INGRESS, profiles: ['default'] });
                // PROTO_B: AUTH is PROCESS (Late Binding)
                registry.registerMockSlot({ name: 'AUTH', protocol: PROTO_B, stage: types_1.SlotStage.PROCESS, profiles: ['default'] });
                sorter = new sorter_1.PipelineSorter(registry);
                instructions = [
