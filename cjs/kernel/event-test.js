    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            return [2 /*return*/, di_1.Injector.create([
                    ...
                    bus_1.KernelEventBus, // [NEW] Inject EventBus
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    policy_1.KernelPolicy.applyConfig({ timeout: 0, concurrency: 0, debug: true }); // Enable debug logging
                    dispatcher = injector.get(dispatcher_1.KernelDispatcher);
                    bus = injector.get(bus_1.KernelEventBus);
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    policy_1.KernelPolicy.applyConfig({ timeout: 0, concurrency: 1 });
                    dispatcher = injector.get(dispatcher_1.KernelDispatcher);
                    bus = injector.get(bus_1.KernelEventBus);
                    ...
                    runner = function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                        var _this = this;
                        return tslib_1.__generator(this, function (_a) {
                            return [2 /*return*/, composed(ctx, function () { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
                                    return [2 /*return*/];
                                }); }); })];
                        });
                    }); };
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    policy_1.KernelPolicy.applyConfig({ timeout: 0, concurrency: 0, debug: false });
                    dispatcher = injector.get(dispatcher_1.KernelDispatcher);
                    composer = injector.get(composer_1.PipelineComposer);
                    nextCalled = false;
                    customNext = function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                        return tslib_1.__generator(this, function (_a) {
                            nextCalled = true;
