...
var KernelEventBus = /** @class */ (function () {
    ...
    KernelEventBus.prototype.logError = function (event, err) {
        if (policy_1.KernelPolicy.debugMode) {
            policy_1.KernelPolicy.logger.error("[KernelEventBus] Handler error for '".concat(event, "':"), err);
        }
    };
    KernelEventBus = tslib_1.__decorate([
        (0, di_1.Injectable)()
    ], KernelEventBus);
    return KernelEventBus;
}());
exports.KernelEventBus = KernelEventBus;