...
var ProtocolStore = /** @class */ (function () {
    ...
    ProtocolStore.prototype.registerSlot = function (reg) {
        ...
        if (this.slots.has(name)) {
            throw new exceptions_1.RuntimeConfigurationException("Slot '".concat(name, "' is already registered for Protocol '").concat(String(reg.definition.protocol), "'. Duplicate registration detected."), { slotName: name });
        }
        // Default profile
...
exports.ProtocolStore = ProtocolStore;