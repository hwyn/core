import { __awaiter, __decorate, __generator, __metadata, __read, __values } from "tslib";
...
var PipelineCompiler = /** @class */ (function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        _a = __values(definitions.instructions), _b = _a.next();
                        _d.label = 2;
                    case 2:
    ...
    PipelineCompiler.prototype.collectRaw = function (bucket, instructions, priority, requiredProtocol) {
        var e_3, _a;
        try {
            for (var instructions_2 = __values(instructions), instructions_2_1 = instructions_2.next(); !instructions_2_1.done; instructions_2_1 = instructions_2.next()) {
    ...
    PipelineCompiler.prototype.harvestSystemSlots = function (seed, activeSlots, collect) {
        var e_4, _a, e_5, _b;
        try {
            for (var _c = __values(activeSlots.keys()), _d = _c.next(); !_d.done; _d = _c.next()) {
                ...
                try {
                    for (var allInstructions_1 = (e_5 = void 0, __values(allInstructions)), allInstructions_1_1 = allInstructions_1.next(); !allInstructions_1_1.done; allInstructions_1_1 = allInstructions_1.next()) {
    ...
    PipelineCompiler.prototype.resolveConflicts = function (rawBucket) {
        ...
        try {
            for (var rawBucket_1 = __values(rawBucket), rawBucket_1_1 = rawBucket_1.next(); !rawBucket_1_1.done; rawBucket_1_1 = rawBucket_1.next()) {
                var _d = __read(rawBucket_1_1.value, 2), slotName = _d[0], map = _d[1];
                ...
                try {
                    for (var candidates_1 = (e_8 = void 0, __values(candidates)), candidates_1_1 = candidates_1.next(); !candidates_1_1.done; candidates_1_1 = candidates_1.next()) {
                        ...
                        var effectiveAction = action || InstructionAction.ADD;
                        switch (effectiveAction) {
                            ...
                            case InstructionAction.EXCLUDE:
                                ...
                                if (!survivors.delete(targetToken)) {
                                    KernelPolicy.logger.warn("[PipelineCompiler] \u26A0\uFE0F Config Warning: Slot '".concat(slotName, "' contains an EXCLUDE instruction for token '").concat(targetToken, "', but that token was not found in the pipeline. This may be a typo or the target instruction was never loaded."));
                                }
                                break;
    ...
    PipelineCompiler.prototype.sortResolved = function (resolvedMap, protocol) {
        ...
        try {
            ...
            for (var _c = __values(resolvedMap.values()), _d = _c.next(); !_d.done; _d = _c.next()) {
                var list = _d.value;
                try {
