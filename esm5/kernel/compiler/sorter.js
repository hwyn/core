import { __decorate, __metadata, __read, __spreadArray, __values } from "tslib";
...
var PipelineSorter = /** @class */ (function () {
    function PipelineSorter(registry) {
        ...
        this.STAGE_WEIGHT = (_a = {},
            _a[SlotStage.INGRESS] = 0,
            _a[SlotStage.PROCESS] = 1,
            _a[SlotStage.EGRESS] = 2,
            _a);
    ...
    PipelineSorter.prototype.groupAndSort = function (instructions, protocol) {
        var e_1, _a;
        var _b;
        var isDebug = KernelPolicy.debugMode;
        if (isDebug) {
            KernelPolicy.logger.log("[PipelineSorter] Sorting ".concat(instructions.length, " instructions for Protocol: ").concat(String(protocol), "."));
        }
        ...
        var assembleStage = function (stage) {
            ...
            var result = [];
            try {
                for (var slotOrder_1 = __values(slotOrder), slotOrder_1_1 = slotOrder_1.next(); !slotOrder_1_1.done; slotOrder_1_1 = slotOrder_1.next()) {
                    ...
                    if (bucket) {
                        ...
                        try {
                            for (var bucket_1 = (e_3 = void 0, __values(bucket)), bucket_1_1 = bucket_1.next(); !bucket_1_1.done; bucket_1_1 = bucket_1.next()) {
    ...
    PipelineSorter.prototype.sort = function (instructions, protocol) {
        ...
        return __spreadArray(__spreadArray(__spreadArray([], __read(grouped.ingress), false), __read(grouped.process), false), __read(grouped.egress), false);
    };
    PipelineSorter.prototype.computeSlotSequence = function (protocol) {
        ...
        try {
            for (var allSlots_1 = __values(allSlots), allSlots_1_1 = allSlots_1.next(); !allSlots_1_1.done; allSlots_1_1 = allSlots_1.next()) {
        ...
        try {
            for (var _d = __values(this.STAGES), _e = _d.next(); !_e.done; _e = _d.next()) {
                var stage = _e.value;
    ...
    PipelineSorter.prototype.sortSlotsInStage = function (slots, stage, protocol) {
        ...
        return __spreadArray(__spreadArray(__spreadArray([], __read(sortedHeads), false), __read(sortedBodies), false), __read(sortedTails), false);
    };
    PipelineSorter.prototype.performTopologicalSort = function (slots, stage, protocol) {
        ...
        try {
            for (var slots_3 = __values(slots), slots_3_1 = slots_3.next(); !slots_3_1.done; slots_3_1 = slots_3.next()) {
                var slot = slots_3_1.value;
                if ((_f = slot.anchors) === null || _f === void 0 ? void 0 : _f.before) {
                    try {
                        for (var _h = (e_9 = void 0, __values(slot.anchors.before)), _j = _h.next(); !_j.done; _j = _h.next()) {
                ...
                if ((_g = slot.anchors) === null || _g === void 0 ? void 0 : _g.after) {
                    try {
                        for (var _k = (e_10 = void 0, __values(slot.anchors.after)), _l = _k.next(); !_l.done; _l = _k.next()) {
        ...
        while (queue.length > 0) {
            ...
            if (neighbors) {
                ...
                try {
                    for (var sortedNeighbors_1 = (e_11 = void 0, __values(sortedNeighbors)), sortedNeighbors_1_1 = sortedNeighbors_1.next(); !sortedNeighbors_1_1.done; sortedNeighbors_1_1 = sortedNeighbors_1.next()) {
