...
var KernelException = /** @class */ (function (_super) {
    __extends(KernelException, _super);
...
var PipelineAbortedException = /** @class */ (function (_super) {
    __extends(PipelineAbortedException, _super);
...
export { PipelineAbortedException };
/**
...
var RuntimeConfigurationException = /** @class */ (function (_super) {
    __extends(RuntimeConfigurationException, _super);
...
export { RuntimeConfigurationException };
/**
