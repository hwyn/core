import { __decorate, __read, __spreadArray, __values } from "tslib";
...
var Registry = /** @class */ (function () {
    ...
    Registry.prototype.registerInstructions = function (batch) {
        var e_1, _a;
        try {
            for (var batch_1 = __values(batch), batch_1_1 = batch_1.next(); !batch_1_1.done; batch_1_1 = batch_1.next()) {
                var inst = batch_1_1.value;
                // Safety check just in case types are loose somewhere
                if (!inst.protocol) {
                    throw new RuntimeConfigurationException("Protocol Violation: Instruction for slot '".concat(inst.slotName, "' is missing a Protocol."), { slotName: inst.slotName });
                }
    ...
    Registry.prototype.registerSeeds = function (seeds) {
        var e_2, _a;
        try {
            for (var seeds_1 = __values(seeds), seeds_1_1 = seeds_1.next(); !seeds_1_1.done; seeds_1_1 = seeds_1.next()) {
    ...
    Registry.prototype.getIngressSeeds = function (protocol) {
        ...
        var all = [];
        try {
            for (var _b = __values(this.stores.values()), _c = _b.next(); !_c.done; _c = _b.next()) {
                var store = _c.value;
                all.push.apply(all, __spreadArray([], __read(store.seeds.ingress), false));
            }
        }
    ...
    Registry.prototype.getProcessSeeds = function (protocol) {
        ...
        try {
            for (var _b = __values(this.stores.values()), _c = _b.next(); !_c.done; _c = _b.next()) {
                var store = _c.value;
                all.push.apply(all, __spreadArray([], __read(store.seeds.process), false));
            }
        }
    ...
    Registry.prototype.getMethodInstructions = function (target, propertyKey, protocol) {
        ...
        try {
            for (var _b = __values(this.stores.values()), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                if (methodInsts) {
                    all.push.apply(all, __spreadArray([], __read(methodInsts), false));
                }
            }
        }
    ...
    Registry.prototype.getSlotsByProfile = function (profile, protocol) {
        ...
        try {
            // 1. Direct Matches
            for (var _d = __values(store.slots.values()), _e = _d.next(); !_e.done; _e = _d.next()) {
                var slot = _e.value;
        ...
        try {
            // 2. Wildcard Matches
            for (var _f = __values(store.wildcardSlots), _g = _f.next(); !_g.done; _g = _f.next()) {
                var _h = _g.value, slot = _h.slot, matchers = _h.matchers;
                if (distinctSlots.has(slot)) {
                    continue;
                }
                try {
                    for (var matchers_1 = (e_8 = void 0, __values(matchers)), matchers_1_1 = matchers_1.next(); !matchers_1_1.done; matchers_1_1 = matchers_1.next()) {
