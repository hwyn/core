...
var ChaosResolverToken = InjectorToken.get('ChaosResolver');
// -------------------------------------------------------------
// TEST COMPONENTS (MOCKS) -> REAL IMPLEMENTATIONS
// -------------------------------------------------------------
// Helper for Async Simulation
export var randomDelay = function (ms) { return new Promise(function (resolve) { return setTimeout(resolve, ms); }); };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, randomDelay(Math.random() * 5)];
                    case 1:
                        // Simulate IO latency in Authentication
                        _a.sent();
